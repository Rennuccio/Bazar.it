...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Líneas de lenguaje para la validación
    |--------------------------------------------------------------------------
    |
    ...
    */
    ...
    | la convención "atributo.regla" para nombrar las líneas. Esto hace que sea rápido
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas de lenguaje se usan para reemplazar nuestro marcador de posición
    | de atributo por algo más amigable para el lector, como "Dirección de correo electrónico"
